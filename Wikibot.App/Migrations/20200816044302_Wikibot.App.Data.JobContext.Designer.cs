...
namespace Wikibot.App.Migrations
{
    ...
    [Migration("20200816044302_Wikibot.App.Data.JobContext")]
    partial class WikibotAppDataJobContext
    {
            ...
            modelBuilder.Entity("Wikibot.App.Jobs.WikiJob", b =>
                {
                    ...
                    b.Property<DateTime>("TimePreFinished")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("TimePreStarted")
                        .HasColumnType("datetime2");
